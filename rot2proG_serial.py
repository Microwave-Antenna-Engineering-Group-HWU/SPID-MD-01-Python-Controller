...
class Rot2proG:
	...
	def status(self):
		...
		# In Python 3, pySerial expects bytes when writing to a serial port. 
		# If packet is a str, pySerial automatically converts it to bytes by encoding 
		# it using ASCII or another default encoding.
...
if __name__ == "__main__":
	rot = Rot2proG('COM1', debugging=True)
	rot.cmd_mode()
	del rot
	print("Done")